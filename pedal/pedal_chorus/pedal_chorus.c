...
int main(void) {
    ...
    gpio_put(PEDAL_CHORUS_LED_GPIO, 1);
    /* Initialize PWM and Switch */
    pedal_pico_chorus = util_pedal_pico_init(UTIL_PEDAL_PICO_PWM_1_GPIO, UTIL_PEDAL_PICO_PWM_2_GPIO);
    /* Initialize ADC */
    ...
    util_pedal_pico_process = pedal_pico_chorus_process;
    /* Launch Core 1 */
    ...
    while (true) {
        //printf("@main 1 - pedal_pico_chorus_conversion_1 %08x\n", pedal_pico_chorus_conversion_1);
        //printf("@main 2 - pedal_pico_chorus_conversion_2 %08x\n", pedal_pico_chorus_conversion_2);
        //printf("@main 3 - pedal_pico_chorus_conversion_3 %08x\n", pedal_pico_chorus_conversion_3);

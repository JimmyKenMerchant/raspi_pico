...
void pedal_chorus_core_1() {
    ...
    util_pedal_pico_on_adc_conversion_1 = PEDAL_CHORUS_ADC_MIDDLE_DEFAULT;
    util_pedal_pico_on_adc_conversion_2 = PEDAL_CHORUS_ADC_MIDDLE_DEFAULT;
    util_pedal_pico_on_adc_conversion_3 = PEDAL_CHORUS_ADC_MIDDLE_DEFAULT;

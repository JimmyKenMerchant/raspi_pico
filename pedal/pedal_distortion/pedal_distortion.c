...
int main(void) {
    ...
    /* Initialize PWM */
    pedal_pico_distortion = util_pedal_pico_init(PEDAL_PICO_DISTORTION_PWM_1_GPIO, PEDAL_PICO_DISTORTION_PWM_2_GPIO);
    /* Initialize ADC */
    util_pedal_pico_init_adc();
    /* Assign Actual Array */
    #if UTIL_PEDAL_PICO_EX_PEAK == PEDAL_PICO_DISTORTION_PWM_PEAK
    ...
    multicore_launch_core1_with_stack(pedal_pico_distortion_start, stack_pointer, PEDAL_DISTORTION_CORE_1_STACK_SIZE);
    //pedal_pico_distortion_debug_time = 0;
    //uint32 from_time = time_us_32();
    //printf("@main 1 - Let's Start!\n");
    //pedal_pico_distortion_debug_time = time_us_32() - from_time;
    //printf("@main 2 - pedal_pico_distortion_debug_time %d\n", pedal_pico_distortion_debug_time);
    while (true) {
        //printf("@main 3 - pedal_pico_distortion_conversion_1 %0x\n", pedal_pico_distortion_conversion_1);
        //printf("@main 4 - pedal_pico_distortion_conversion_2 %0x\n", pedal_pico_distortion_conversion_2);
        //printf("@main 5 - pedal_pico_distortion_conversion_3 %0x\n", pedal_pico_distortion_conversion_3);
        //printf("@main 6 - multicore_fifo_pop_blocking() %d\n", multicore_fifo_pop_blocking());
        //printf("@main 7 - pedal_pico_distortion_debug_time %d\n", pedal_pico_distortion_debug_time);
        //sleep_ms(500);
        //tight_loop_contents();
        __wfi();
    }

...
int main(void) {
    ...
    while (true) {
        //printf("@main 1 - pedal_pico_sideband_conversion_1 %08x\n", pedal_pico_sideband_conversion_1);
        //printf("@main 2 - pedal_pico_sideband_conversion_2 %08x\n", pedal_pico_sideband_conversion_2);
        //printf("@main 3 - pedal_pico_sideband_conversion_3 %08x\n", pedal_pico_sideband_conversion_3);

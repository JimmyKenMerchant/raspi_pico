...
volatile uint16 pedal_reverb_conversion_1_temp;
volatile uint16 pedal_reverb_conversion_2_temp;
volatile uint16 pedal_reverb_conversion_3_temp;
...
volatile bool pedal_reverb_is_outstanding_on_adc;

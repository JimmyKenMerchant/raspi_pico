...
void pedal_pico_tremolo_set() {
    ...
    pedal_pico_tremolo_osc_speed = pedal_pico_tremolo_conversion_2 >> UTIL_PEDAL_PICO_ADC_FINE_SHIFT; // Make 5-bit Value (0-31)
    pedal_pico_tremolo_osc_is_negative = false;
    pedal_pico_tremolo_osc_start_threshold = (pedal_pico_tremolo_conversion_3 >> UTIL_PEDAL_PICO_ADC_FINE_SHIFT) * PEDAL_PICO_TREMOLO_OSC_START_THRESHOLD_MULTIPLIER; // Make 5-bit Value (0-31) and Multiply

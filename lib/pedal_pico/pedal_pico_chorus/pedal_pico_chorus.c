...
void pedal_pico_chorus_set() {
    ...
    pedal_pico_chorus_osc_speed = pedal_pico_chorus_conversion_2 >> UTIL_PEDAL_PICO_ADC_FINE_SHIFT; // Make 6-bit Value (0-63)
    ...
    uint16_t lr_distance_time = (pedal_pico_chorus_conversion_3 >> UTIL_PEDAL_PICO_ADC_FINE_SHIFT) << PEDAL_PICO_CHORUS_LR_DISTANCE_TIME_SHIFT; // Make 6-bit Value (0-63) and Shift
...
void pedal_pico_chorus_process(int32_t normalized_1, uint16_t conversion_2, uint16_t conversion_3, uint8_t sw_mode) {
    ...
    if (abs(conversion_3 - pedal_pico_chorus_conversion_3) >= UTIL_PEDAL_PICO_ADC_FINE_THRESHOLD) {
        ...
        pedal_pico_chorus_lr_distance_time = (pedal_pico_chorus_conversion_3 >> UTIL_PEDAL_PICO_ADC_FINE_SHIFT) << PEDAL_PICO_CHORUS_LR_DISTANCE_TIME_SHIFT; // Make 6-bit Value (0-63) and Shift
    }

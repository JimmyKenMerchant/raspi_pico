...
void pedal_pico_tape_set() {
    ...
    pedal_pico_tape_delay_time_swing = (pedal_pico_tape_conversion_2 >> UTIL_PEDAL_PICO_ADC_FINE_SHIFT) << PEDAL_PICO_TAPE_DELAY_TIME_SWING_SHIFT; // Make 6-bit Value (0-63) and Shift
    pedal_pico_tape_delay_index = 0;
    pedal_pico_tape_osc_speed = pedal_pico_tape_conversion_3 >> UTIL_PEDAL_PICO_ADC_FINE_SHIFT; // Make 6-bit Value (0-63)

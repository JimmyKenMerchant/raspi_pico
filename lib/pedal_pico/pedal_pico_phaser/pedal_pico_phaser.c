...
void pedal_pico_phaser_set() {
    ...
    pedal_pico_phaser_osc_start_threshold = (uint16_t)((pedal_pico_phaser_conversion_3 >> UTIL_PEDAL_PICO_ADC_SHIFT) * PEDAL_PICO_PHASER_OSC_START_THRESHOLD_MULTIPLIER); // Make 5-bit Value (0-31) and Multiply

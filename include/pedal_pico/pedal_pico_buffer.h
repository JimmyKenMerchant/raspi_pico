...
#define PEDAL_PICO_BUFFER_DELAY_TIME_SHIFT (7 + (UTIL_PEDAL_PICO_ADC_COARSE_MULTIPLIER >> 1)) // Multiply By 256 (0-7936), 7936 Divided by 28125 (0.282 Seconds)
#define PEDAL_PICO_BUFFER_DELAY_TIME_MAX ((UTIL_PEDAL_PICO_ADC_COARSE_RESOLUTION << PEDAL_PICO_BUFFER_DELAY_TIME_SHIFT) + 1) // Don't Use Delay Time = 0
...
#define PEDAL_PICO_BUFFER_NOISE_GATE_THRESHOLD_MULTIPLIER (1 * UTIL_PEDAL_PICO_ADC_COARSE_MULTIPLIER) // Up to -30.37dB (Loss 33) in 2047 as Quantization Peak

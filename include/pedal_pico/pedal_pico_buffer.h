...
#define PEDAL_PICO_BUFFER_DELAY_TIME_SHIFT (7 + (UTIL_PEDAL_PICO_ADC_FINE_MULTIPLIER >> 1)) // Multiply By 128 (0-8064), 8064 Divided by 28125 (0.287 Seconds)
...
#define PEDAL_PICO_BUFFER_NOISE_GATE_THRESHOLD_MULTIPLIER (1 * UTIL_PEDAL_PICO_ADC_FINE_MULTIPLIER) // Up to -30.24dB (Loss 32.5) in 2047 as Quantization Peak

...
#define PEDAL_PICO_TREMOLO_OSC_TRIANGLE_1_TIME_MULTIPLIER 108
#define PEDAL_PICO_TREMOLO_OSC_START_HYSTERESIS_SHIFT 1 // Divide by 2
#define PEDAL_PICO_TREMOLO_OSC_START_THRESHOLD_MULTIPLIER 1 // From -66.22dB (Loss 2047) to -36.39dB (Loss 66) in ADC_VREF (Typically 3.3V)

...
#define PEDAL_PICO_TREMOLO_OSC_TRIANGLE_1_TIME_MULTIPLIER (216 / UTIL_PEDAL_PICO_ADC_FINE_MULTIPLIER)
#define PEDAL_PICO_TREMOLO_OSC_START_HYSTERESIS_SHIFT 1 // Divide by 2
#define PEDAL_PICO_TREMOLO_OSC_START_THRESHOLD_MULTIPLIER (1 * UTIL_PEDAL_PICO_ADC_FINE_MULTIPLIER) // Up to -30.24dB (Loss 32.5) in 2047 as Quantization Peak

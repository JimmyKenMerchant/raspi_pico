...
#define PEDAL_PICO_SUSTAIN_AMPLITUDE_SHIFT (10 + (UTIL_PEDAL_PICO_ADC_COARSE_MULTIPLIER >> 1)) // Multiply by 2048 (0x00000000-0x0000F800)
...
#define PEDAL_PICO_SUSTAIN_GATE_THRESHOLD_MULTIPLIER (1 * UTIL_PEDAL_PICO_ADC_COARSE_MULTIPLIER) // From -60.20dB (Loss 1023) to -30.37dB (Loss 33) in 2047 as Quantization Peak

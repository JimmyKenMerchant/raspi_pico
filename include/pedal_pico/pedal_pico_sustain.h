...
#define PEDAL_PICO_SUSTAIN_AMPLITUDE_SHIFT (10 + (UTIL_PEDAL_PICO_ADC_FINE_MULTIPLIER >> 1)) // Multiply by 1024 (0x00000000-0x0000FC00)
...
#define PEDAL_PICO_SUSTAIN_GATE_THRESHOLD_MULTIPLIER (1 * UTIL_PEDAL_PICO_ADC_FINE_MULTIPLIER) // From -66.22dB (Loss 2047) to -30.24dB (Loss 32.5) in 2047 as Quantization Peak

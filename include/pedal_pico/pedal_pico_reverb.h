...
#define PEDAL_PICO_REVERB_DELAY_AMPLITUDE_SHIFT (10 + (UTIL_PEDAL_PICO_ADC_FINE_MULTIPLIER >> 1)) // Multiply by 2048 (0x00000000-0x0000F800)
...
#define PEDAL_PICO_REVERB_DELAY_TIME_SHIFT (8 + (UTIL_PEDAL_PICO_ADC_FINE_MULTIPLIER >> 1)) // Multiply by 512 (0-15872), 15872 Divided by 28125 (0.56 Seconds)

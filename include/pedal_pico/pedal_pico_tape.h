...
#define PEDAL_PICO_TAPE_DELAY_TIME_SWING_SHIFT (5 + (UTIL_PEDAL_PICO_ADC_FINE_MULTIPLIER >> 1)) // Multiply by 64 (0-1984)
#define PEDAL_PICO_TAPE_DELAY_TIME_SWING_PEAK_1 (UTIL_PEDAL_PICO_ADC_FINE_RESOLUTION << PEDAL_PICO_TAPE_DELAY_TIME_SWING_SHIFT) // 1984 Divided by 28125 (0.070 Seconds)

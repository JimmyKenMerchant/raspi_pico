...
#define PEDAL_PICO_TAPE_DELAY_TIME_SWING_SHIFT (5 + (UTIL_PEDAL_PICO_ADC_FINE_MULTIPLIER >> 1)) // Multiply by 32 (0-2016)
#define PEDAL_PICO_TAPE_DELAY_TIME_SWING_PEAK_1 (UTIL_PEDAL_PICO_ADC_FINE_RESOLUTION << PEDAL_PICO_TAPE_DELAY_TIME_SWING_SHIFT) // 2016 Divided by 28125 (0.072 Seconds)
...
#define PEDAL_PICO_TAPE_OSC_SINE_1_TIME_MULTIPLIER (18 / UTIL_PEDAL_PICO_ADC_FINE_MULTIPLIER)

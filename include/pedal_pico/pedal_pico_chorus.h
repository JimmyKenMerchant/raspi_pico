...
#define PEDAL_PICO_CHORUS_LR_DISTANCE_TIME_SHIFT (4 + (UTIL_PEDAL_PICO_ADC_FINE_MULTIPLIER >> 1)) // Multiply By 32 (0-992), 992 Divided by 28125 (0.0353 Seconds = 12.01 Meters)

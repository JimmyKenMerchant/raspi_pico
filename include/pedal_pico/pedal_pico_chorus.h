...
#define PEDAL_PICO_CHORUS_OSC_SINE_1_TIME_MULTIPLIER (12 / UTIL_PEDAL_PICO_ADC_COARSE_MULTIPLIER)
#define PEDAL_PICO_CHORUS_LR_DISTANCE_TIME_SHIFT (4 + (UTIL_PEDAL_PICO_ADC_COARSE_MULTIPLIER >> 1)) // Multiply By 32 (0-992), 992 Divided by 28125 (0.0353 Seconds = 12.01 Meters)
#define PEDAL_PICO_CHORUS_LR_DISTANCE_TIME_MAX ((UTIL_PEDAL_PICO_ADC_COARSE_RESOLUTION << PEDAL_PICO_CHORUS_LR_DISTANCE_TIME_SHIFT) + 1)

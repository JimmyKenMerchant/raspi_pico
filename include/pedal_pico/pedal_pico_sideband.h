...
#define PEDAL_PICO_SIDEBAND_OSC_SINE_1_TIME_MULTIPLIER (12 / UTIL_PEDAL_PICO_ADC_FINE_MULTIPLIER)
#define PEDAL_PICO_SIDEBAND_OSC_SINE_2_TIME_MULTIPLIER (8 / UTIL_PEDAL_PICO_ADC_FINE_MULTIPLIER)
#define PEDAL_PICO_SIDEBAND_OSC_PEAK 1023
#define PEDAL_PICO_SIDEBAND_OSC_START_HYSTERESIS_SHIFT 1 // Divide by 2
#define PEDAL_PICO_SIDEBAND_OSC_START_THRESHOLD_MULTIPLIER (1 * UTIL_PEDAL_PICO_ADC_FINE_MULTIPLIER) // Up to -30.24dB (Loss 32.5) in 2047 as Quantization Peak

...
* Room Reverb is the combination of the Reverb and the Chorus. ADC0 is for the audio input. In this effect, functions of ADC1 and ADC2 are banked by the states of Switch-1 and Switch-2. In the low state of Switch-1, ADC1 and ADC2 act as the same as Reverb. In the low state of Switch-2, ADC1 and ADC2 act as the same as Chorus that is like sound reflections of a room. In the high states of both switches, ADC1 and ADC2 aren't functioned. I thought this combination makes natural reverberation in a room. The sound of this effect is like in a tall lobby of a shopping mall, i.e., there is a lot of factors to reflect. Whereas, the sound of the Chorus is like in an open lobby of a hotel.

...
* "pedal_chorus" is using a delay without feedback. However, to get the spatial expanse, we need an oscillator and another delay, i.e., this pedal is simulating a stereo speaker which output the delay alternately. ADC0 is for the audio input, ADC1 is for the distance between L and R, and ADC2 is for the speed of the oscillator. Outputs are gained two times in default. One of two outputs is L, and another is R which is delayed to simulate the distance of two speakers.

...
* "pedal_chorus" is using a delay without feedback. ADC0 is for the audio input, ADC1 is for the amplitude of the delay, and ADC2 is for the response (delay time). Outputs are gained two times in default. One of two outputs is added the delay, and another is added the inverted delay.
